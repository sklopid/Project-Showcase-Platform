<template>
    <div>
        ...
        <div class="card" style="margin-bottom: 1px;">
          <el-table :data="data.tableData" style="width: 100%" @selection-change="handleSelectChange" :header-cell-style="{fontWeight:'bold',color:'#333',backgroundColor: 'red'}" row-key="id">
        ...
        <el-dialog v-model="data.formVisible" title="user message" width="500" destroy-on-close>
